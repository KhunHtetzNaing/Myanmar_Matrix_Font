...
Sub b1_Click
	...
	File.Copy(File.DirAssets,"MatrixO.apk",File.DirRootExternal,"MatrixO.apk")
	Dim ii As Intent
	ii.Initialize(ii.ACTION_VIEW,"file:///"&File.DirRootExternal& "/MatrixO.apk")
...
Sub b2_Click
	If File.Exists(File.DirRootExternal,"MatrixO.apk") = True Then
		File.Delete(File.DirRootExternal,"MatrixO.apk")
	End If
	Try
		Dim abc As Intent
		abc.Initialize("", "")
