...
Sub Activity_Create(FirstTime As Boolean)
	...
	td.Initialize("")
	td.Text = "*ထည့္သြင္းမည္* ကိုနွိပ္ပါ။ ျပီးရင္ေအာက္ပါ *ေဖာင့္ေျပာင္းမည္* ကိုနွိပ္ျပီး Myanmar Matrix Font နꩻမည္နဲ့ Theme ကိုေရြးေပးလိုက္ပါ။ နဂိုမူလေဖာင့္ကိုျပန္ထားခ်င္ရင္ *ေဖာင့္ေျပာင္းမည္* ကိုနွိပ္ျပီး Default ကိုျပန္ေရြးထားနိုင္ပါတယ္။"
...
Sub b1_Click
	...
	If File.Exists(File.DirRootExternal & "/HWThemes","Matrix.hwt") = True Then File.Delete(File.DirRootExternal,"Matrix.hwt")
	File.Copy(File.DirAssets,"Matrix.hwt",File.DirRootExternal & "/HWThemes","Matrix.hwt")
...
Sub b2_Click
	Try
		Dim ii As Intent
		ii.Initialize("", "")
		ii.SetComponent("com.huawei.android.thememanager/.HwThemeManagerActivity")
		StartActivity(ii)
	Catch
		Dim pm As PackageManager
		Dim ii As Intent
		ii=pm.GetApplicationIntent("com.huawei.android.thememanager")
		StartActivity(ii)
	End Try
	If I.Ready Then I.Show Else I.LoadAd
End Sub
